...
class APICaller {
    ...
    func getCourse(courseID: Int64, delay: Double, retries: Int, _ completion: @escaping (Course) -> ()) {
        let timer = Timer(timeInterval: delay, repeats: false) { timer in
    ...
    func getCourseAssignments(courseID: Int64, delay: Double, retries: Int, _ completion: @escaping ([Assignment]) -> ()) {
        let timer = Timer(timeInterval: delay, repeats: false) { timer in
